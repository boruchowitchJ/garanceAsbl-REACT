...
import {
  MDBInput,
  MDBCheckbox,
  MDBBtn,MDBRow, MDBCol,MDBTextArea, MDBIcon
...
export const Contact= () =>  {
  return (
    <section className='container_pourvous'style={{ marginTop:"15%", width:"80%",display:"flex", justifyContent:"space-between",marginLeft: "10%",
    flexWrap: "wrap" }}>
          <MDBRow className='w-100'style={{display:"flex", justifyContent:"space-around"}}>
