...
<span> <span className='link' > Prévenir les violences</span>: au travail, on rencontre souvent des situations d’agression, de la part de client/e/s, de collègues ou du grand public. Vous pouvez garder votre calme et agir avant que les choses ne s’enveniment !

</span><br /><br />
<span ><span className='link' > L’état du stress post-traumatique (PTSD)</span> : Des victimes de violences souffrent de divers symptômes, parfois des années après les faits. Il s’agit de reconnaître ces symptômes, d’adapter l’intervention aux besoins de la victime et de pouvoir la réorienter vers les services les plus compétents.

</span><br /><br />
<span><span className='link'> Rendre l’autonomie aux victimes d’infraction (RAVI)</span> : C’est une tâche complexe de donner des conseils de sécurité à des victimes d’infraction sans les culpabiliser. Voici des réponses !

</span><br /><br />
<span><span className='link'> Le système des drapeaux</span> : Réagir aux comportements sexuels des enfants et des jeunes n’est pas toujours évident. Cette méthode vous permettra d’évaluer des situations à teneur sexuelle et d’y réagir avec la bonne mesure.
