            ...
            >
              <div className="d-flex justify-content-center align-items-center h-100">
                <div className="text-white text-center tittle_hero">
                  ...
                  <HashLink className="btn  m-2 link" to="/#valeur">
                    Valeur
                  </HashLink>
                </div>
              </div>
            ...
            >
              <div className="d-flex justify-content-center align-items-center h-100">
                <div className="text-white text-center tittle_hero">
                  ...
                  <HashLink className="btn  m-2 link" to="/ecrits">
                    Témoignez
                  </HashLink>
                </div>
              </div>
          ...
          <div className="container">
            ...
            <div className="mt-1 ">
              <section className="soutenir" id="soutenir">
                <h1 className=" p-4 mb-3 text-uppercase text-center">
                  {" "}
                  Nous soutenir
                </h1>
                  ...
                  <ScrollAnimation animateIn="fadeInLeft">
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-4">
                        <div className="p-4">
                          <p>
                            Ce que Garance a pu réaliser dans le passé a été
                            possible grâce non seulement à l’engagement
                            personnel de son équipe, mais aussi au soutien de la
                            part de particuliers et d’institutions. Pour
                            continuer, nous avons besoin de votre soutien !
                          </p>
                          <p>
                            Investir dans Garance, c’est investir dans la
                            sécurité de toutes et tous ! Vos dons à partir de
                            EUR 40 sont déductibles des impôts. <br /> Vous
                            pouvez verser votre don sur notre compte <br />
                            <br />
                            <ul>
                              ...
                              <li>BIC : TRIOBEBB</li>
                              <li>
                                Pour des raisons administratives, nous ne
                                pouvons pas accepter des chèques. Pour plus de
                                détails, le secrétariat de Garance est à votre
                                disposition.
                              </li>
                            </ul>
                          </p>
                            ...
                            <div>
                              ...
                              <p>
                                ...
                                <p>
                                  ...
                                  membre. En tant que membre, vous vous engagez
                                  à payer une cotisation annuelle (EUR 15) et à
                                  assister aux deux assemblées générales par an.
                                  Vous serez ainsi au courant des plans pour
                                  l’avenir et vous pourrez contribuer à trouver
                                  des solutions aux problèmes que Garance
                                  rencontre.
                                </p>
                              </p>
                              <div className="text-center">
                                <HashLink className="btn link" to="/ecrits">
                                  Devenir membre
                                </HashLink>
                              </div>
                            </div>
                          ...
                          <div>
                            <div>
                              ...
                              <p>
                                ...
                                <p>
                                  Vous pouvez soutenir Garance aussi en tant que
                                  volontaire. Nous cherchons des personnes qui
                                  veulent diffuser nos programmes dans des lieux
                                  publics comme des salles d’attente, qui nous
                                  donnent un coup de main lors d’événements plus
                                  importants ou encore qui souhaitent s’investir
                                  dans le domaine de l’animation, par exemple en
                                  tant qu’éducatrice paire.
                                </p>
                              </p>
                              <div className="text-center">
                                <HashLink className="btn link" to="/ecrits">
                        ...
                        <div className="card-body text-center">
                          ...
                          <p>
                            <ul>
                              <li>
                                {" "}
                                Renforcer le pouvoir et la sécurité des femmes{" "}
                              </li>
                              <li>
                                {" "}
                                Agir politiquement pour la prévention primaire
