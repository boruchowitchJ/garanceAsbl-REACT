const Histoire = () => {
  ...
  <div className="container_pourvous">
    ...
    <p>Avec son projet « Thelma et Louise », Garance fut finaliste du concours mondial Stop Rape Contest, en février 2001, et participa à ce titre au V-Day au Madison Square Garden à New York.
    Entre 2001 et 2003, Garance a coopéré à deux projets européens, d’une part sur les violences faites aux lesbiennes et, d’autre part, sur l’offre en autodéfense pour femmes et filles en Union européenne. À cette occasion, Garance a rencontré des formatrices d’autodéfense de toute l’Europe.</p>

    <h2>Echappez belle !</h2>
    <p>À l’occasion de la Journée internationale contre la violence à l’égard des femmes, le 25 novembre 2002, le projet Echappées Belles est lancé : Il s’agit de recueillir des témoignages de femmes qui d’une manière ou d’une autre ont réussi à se défendre lors d’une agression, et de partager ce réservoir de moyens pour que toutes puissent s’en inspirer (les mots bien trouvés, la fuite quand elle est possible, les mille et une petites astuces utilisées).
...
En 2004, l’opération « Faire un scandale » pour lutter contre le sentiment d’insécurité des femmes dans l’espace public remporte un grand succès et durant le mois de novembre, 5000 sifflets d’alarme sont distribués à Bruxelles.</p>

    <h2>La reconnaissance</h2>
    <p>Tous ces efforts sont récompensés le 19 avril 2005 quand, au Flagey, lors de la représentation exceptionnelle des « Monologues du Vagin » pour ce premier Jour V européen, en présence d’Eve Ensler et d’une belle troupe de célébrités, Garance est désignée comme une des associations bénéficiaires de cette rencontre internationale.
...
Toujours en 2007, huit nouvelles formatrices d’autodéfense sont formées, qui dissémineront leur savoir dans d’autres organisations pour femmes. Garance entame également un travail spécifique pour les femmes 55+ : enquêtes, activités spécifiques pour elles et, à partir de 2008, une toute nouvelle approche – l’éducation par les paires. Ce sont dorénavant des femmes 55+ qui animeront, formées et soutenues par Garance, des groupes de réflexion pour lutter contre le sentiment d’insécurité.</p>

    <h2>Les hommes et l’avenir</h2>
    <p>Ce n’est pas un secret que les garçons et les hommes peuvent aussi devenir victimes de violence. C’est pourquoi Garance commence, à partir de 2007, à collecter des informations sur les violences qui leur sont faites et développe une méthodologie pédagogique pour le travail avec les garçons. Pour des raisons de financement, cette nouvelle approche reste inutilisée - pour le moment.
